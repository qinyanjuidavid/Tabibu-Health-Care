    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_time', models.TimeField(default=datetime.time(16, 42, 20, 720124), verbose_name='appointment time')),
                ...
                ('status', models.CharField(choices=[('Cancelled', 'Cancelled'), ('Completed', 'Completed'), ('Pending', 'Pending')], default='Pending', max_length=20, verbose_name='status')),
